...
export default function Course() {
    ...
    const getData = async () => {
        try {
            const response = await fetch("http://localhost:8000/api/v1/courses/list-courses");
    ...
    const handleAdd = async (data) => {
        ...
        try {
            await fetch("http://localhost:8000/api/v1/courses/add-courses", {
                method: "POST",
                headers: {
    ...
    const handleDelete = async (data) => {
        ...
        try {
            await fetch("http://localhost:8000/api/v1/courses/delete-courses/" + data._id, {
                method: "DELETE",
            })
        } catch (error) {
            console.log(error);
    ...
    const handleUpdateData = async (data) => {
        ...
        try {
            await fetch("http://localhost:8000/api/v1/courses/update-courses/" + data._id, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                },
